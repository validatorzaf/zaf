...
Aktivní:: skartační řízení (jen metadata), skartační řízení (jen metadata), skartační řízení (s komponentami), skartační řízení (s komponentami), přejímka, přejímka
...
Kód:: obs54
Zdroj:: Bod 1.17 a 1.18 přílohy č. 2 NSESSS; Informační list NA, čá. 2/2018, příloha k č. 20/2018 (20.3).
