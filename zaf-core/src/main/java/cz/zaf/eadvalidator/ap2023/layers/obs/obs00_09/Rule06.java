...
public class Rule06 extends EadRule {
	...
	static final public String RULE_TEXT = "Element <ead:filedesc> obsahuje právě jeden element <ead:publicationstmt>.";
	static final public String RULE_ERROR = "Element <ead:filedesc> neobsahuje právě jeden element <ead:publicationstmt>.";
