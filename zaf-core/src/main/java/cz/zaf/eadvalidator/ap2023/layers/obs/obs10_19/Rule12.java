...
public class Rule12 extends EadRule {
	...
	static final public String RULE_TEXT = "Element <ead:publicationstmt> obsahuje právě jeden takový element <ead:p>, který obsahuje právě jeden element <ead:name> s atributem \"localtype\" o hodnotě \"FINDING_AID_EDITOR\", který obsahuje alespoň jeden neprázdný element <ead:part>.";
	static final public String RULE_ERROR = "Struktura elementu <ead:publicationstmt> neobsahuje správně vyplněný element <ead:name> s atributem \"localtype\" o hodnotě \"FINDING_AID_EDITOR\" vnořený do elementu <ead:p>.";
			...
			if(pda instanceof P) {
				...
				for(Object pCont: pConts) {
					...
					if(pCont instanceof Name) {
						...
						if("FINDING_AID_EDITOR".equals(name.getLocaltype())) {
							if(found!=null) {
