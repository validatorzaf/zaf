...
public class Rule29 extends EadRule {

    static final public String CODE = "obs29";
    static final public String RULE_TEXT = "Pokud element <ead:term>, který je obsažen v elementu <ead:localcontrol> s atributem \"localtype\" o hodnotě \"RULES\", má atribut \"identifier\" o hodnotě \"CZ_ZP1958\", tak element <ead:term>, který je obsažen v elementu <ead:localcontrol> s atributem \"localtype\" o hodnotě \"FINDING_AID_TYPE\", má atribut \"identifier\" o některé z následujících hodnot: PROZ_INV_SEZNAM, MANIP_SEZNAM, INVENTAR, KATALOG";
    static final public String RULE_ERROR = "Element <ead:term>, který je obsažen v elementu <ead:localcontrol> s atributem \"localtype\" o hodnotě \"FINDING_AID_TYPE\", nemá atribut \"identifier\" nebo tento atribut obsahuje nepovolenou hodnotu.";
    static final public String RULE_SOURCE = "Část 2.6 profilu EAD3 MV ČR";
        ...
        if (!CollectionUtils.isEmpty(loccontrol)) {
            for (Localcontrol localcontrol : loccontrol) {
                if (EadNS.LOCALTYPE_RULES.equals(localcontrol.getLocaltype())) {
                    ...
                    if (EadNS.IDENTIFIER_CZ_ZP1958.equals(termIdent)) {
                        termCondition1 = term;
                    }
                }
            ...
            if (termCondition1 != null) {
                ...
                if (!(EadNS.IDENTIFIER_PROZ_INV_SEZNAM.equals(identifier) || "MANIP_SEZNAM".equals(identifier) || EadNS.IDENTIFIER_INVENTAR.equals(identifier) || EadNS.IDENTIFIER_KATALOG.equals(identifier))) {
