...
public class Rule65 extends EadRule {
    ...
    static final public String RULE_TEXT = "Element <accessrestrict> se může vykytovat pouze jednou a obsahuje právě jeden neprázdný element <p>.";
    static final public String RULE_ERROR = "Některý element <accessrestrict> neobsahuje právě jeden element <p>. Případně je element <p> prázdný.";
