    ...
    private void readSpaceoccupied(Did did) {
        ...
        for (Object child : did.getMDid()) {
            if (child instanceof Physdescstructured physdescstructured) {
                ...
                if (!StringUtils.equals("spaceoccupied", physdescstructuredtype)) {
                    continue;
                }
                ...
                if (!"whole".equals(coverage)) {
                    throw new ZafException(BaseCode.CHYBNA_HODNOTA_ELEMENTU,
                            "Element physdescstructured s atributem physdescstructuredtype=\"spaceoccupied\" nemá atribut coverage=\"whole\".",
                ...
                if (StringUtils.equals("bm", contentUnitType)) {
                    ...
                    foundByte = unittype;
                    if (!isPositiveInteger(contentQuantity)) {
