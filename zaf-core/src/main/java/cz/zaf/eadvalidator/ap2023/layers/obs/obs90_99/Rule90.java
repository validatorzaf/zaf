...
public class Rule90 extends EadRule {

    static final public String CODE = "obs90";
    static final public String RULE_TEXT = "Každý element <ead:materialspec> s atributem \"localtype\"o hodnotě \"VOLUME\" obsahuje prostou textovou hodnotu.";
    static final public String RULE_ERROR = "Některý element <ead:materialspec> s atributem \"localtype\" o hodnotě \"VOLUME\" neobsahuje prostou textovou hodnotu.";
    static final public String RULE_SOURCE = "Část 6.13 profilu EAD3 MV ČR";
