...
public class Rule63 extends EadRule {
    ...
    static final public String RULE_TEXT = "Každý element <ead:acqinfo> obsahuje právě jeden neprázdný element <ead:p>.";
    static final public String RULE_ERROR = "Některý element <ead:acqinfo> neobsahuje právě jeden element <ead:p>. Případně je element <ead:p> prázdný.";
    ...
    protected void evalImpl() {
        ...
        for (Object archDescChild : archDescChildList) {
            if (archDescChild instanceof Acqinfo) {
    ...
    private void validateMainElement(Object instanceOfObject) {
        Acqinfo elementObject = (Acqinfo) instanceOfObject;
        ...
        for (Object child : childList) {
            ...
            //ead:custodhist
            if (child instanceof Acqinfo) {
                validateMainElement(child);
            }
        }
        if (p == null) {
            throw new ZafException(BaseCode.CHYBI_ELEMENT, "Element <ead:acqinfo> neobsahuje element <ead:p>.", ctx.formatEadPosition(elementObject));
        }
    }
