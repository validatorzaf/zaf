...
public class Rule61 extends EadRule {
    ...
    static final public String RULE_TEXT = "Element <arrangement> se může vykytovat pouze jednou a obsahuje právě jeden neprázdný element <p>.";
    static final public String RULE_ERROR = "Některý element <arrangement> neobsahuje právě jeden element <p>. Případně je element <p> prázdný.";
    ...
    private void validate(List<Object> childList) {
        ...
        for (Object child : childList) {
            if (child instanceof Arrangement mainElement) {
                mainElementCOunt++;
