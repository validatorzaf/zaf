...
public class Rule23 extends EadRule {
    ...
    static final public String RULE_TEXT = "Element <ead:control> obsahuje právě jeden element <ead:localcontrol>, který má atribut \"localtype\" o hodnotě \"FINDING_AID_TYPE\".";
    static final public String RULE_ERROR = "Element <ead:control> neobsahuje právě jeden element <ead:localcontrol> s atributem \"localtype\" o hodnotě \"FINDING_AID_TYPE\".";
    ...
    protected void evalImpl() {
        ...
        if (!CollectionUtils.isEmpty(loccontrol)) {
            for (Localcontrol otherLoccontrol : loccontrol) {
                if ("FINDING_AID_TYPE".equals(otherLoccontrol.getLocaltype())) {
                    if (found != null) {
