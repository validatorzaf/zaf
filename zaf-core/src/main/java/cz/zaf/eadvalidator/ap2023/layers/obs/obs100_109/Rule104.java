...
public class Rule104 extends EadRule {
    ...
    static final public String RULE_TEXT = "Element <ead:relation>, který má atribut \"relationtype\" o hodnotě \"cpfrelation\" nebo \"resourcerelation\", obsahuje právě jeden neprázdný element <ead:relationentry> a element <ead:descriptivenote>.";
    static final public String RULE_ERROR = "Element <ead:relation>, který má atribut \"relationtype\" o hodnotě \"cpfrelation\" nebo \"resourcerelation\", neobsahuje element <ead:relationentry> a/nebo element <ead:descriptivenote>. Případně je element <ead:relationentry> prázdný.";
