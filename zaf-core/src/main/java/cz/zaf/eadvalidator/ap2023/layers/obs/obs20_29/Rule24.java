...
public class Rule24 extends EadRule {
    ...
    static final public String RULE_TEXT = "Element <ead:control> obsahuje právě jeden element <ead:localcontrol>, který má atribut \"localtype\" o hodnotě \"RULES\".";
    static final public String RULE_ERROR = "Element <ead:control> neobsahuje právě jeden element <ead:localcontrol> s atributem \"localtype\" o hodnotě \"RULES\".";
