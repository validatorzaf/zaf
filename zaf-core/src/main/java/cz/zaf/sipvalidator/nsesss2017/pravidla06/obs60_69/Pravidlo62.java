...
public class Pravidlo62 extends K06PravidloBase {
    ...
    protected void kontrola() {
        ...
        for (Element jazyk : jazyky) {
            ...
            if (!jeObsazen) {
                Element elEntita = getEntity(jazyk);
                nastavChybu(BaseCode.CHYBNA_HODNOTA_ELEMENTU, "Nenalezena hodnota odpovídající ISO 639-2:1998.", jazyk, getEntityId(elEntita));
            }
        }
    }
