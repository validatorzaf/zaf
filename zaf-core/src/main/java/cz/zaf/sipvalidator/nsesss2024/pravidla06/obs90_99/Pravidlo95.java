...
public class Pravidlo95 extends K06PravidloBase {
    ...
    protected void kontrola() {
        List<Element> vecneSkupiny = metsParser.getNodes(NsesssV4.VECNA_SKUPINA);
        if (CollectionUtils.isEmpty(vecneSkupiny)) {
            nastavChybu(BaseCode.CHYBI_ELEMENT, "Nenalezen element <nsesss:VecnaSkupina>.");
        }
        List<Element> soucasti = metsParser.getNodes(NsesssV4.SOUCAST);
        List<Element> typoveSpisy = metsParser.getNodes(NsesssV4.TYPOVY_SPIS);

        Iterable<Element> multiCol = IterableUtils.chainedIterable(vecneSkupiny, soucasti, typoveSpisy);
        for (Element entita : multiCol) {
            Element pu_entita = ValuesGetter.getXChild(entita, NsesssV4.EVIDENCNI_UDAJE, NsesssV4.TRIDENI,
            ...
            Element pu_rodic = ValuesGetter.getXChild(entita, NsesssV4.EVIDENCNI_UDAJE, NsesssV4.TRIDENI,
                    ...
                    NsesssV4.EVIDENCNI_UDAJE, NsesssV4.TRIDENI,
                    NsesssV4.PLNE_URCENY_SPISOVY_ZNAK);
            if (pu_rodic == null) {
                pu_rodic = ValuesGetter.getXChild(entita, NsesssV4.EVIDENCNI_UDAJE, NsesssV4.TRIDENI,
            ...
            if (pu_rodic == null) {
                pu_rodic = ValuesGetter.getXChild(entita, NsesssV4.EVIDENCNI_UDAJE, NsesssV4.TRIDENI,
                        NsesssV4.MATERSKA_ENTITA, NsesssV4.SOUCAST, NsesssV4.EVIDENCNI_UDAJE,
                        NsesssV4.TRIDENI, NsesssV4.PLNE_URCENY_SPISOVY_ZNAK);
            }
            if (pu_rodic == null) {
                pu_rodic = ValuesGetter.getXChild(entita, NsesssV4.EVIDENCNI_UDAJE, NsesssV4.TRIDENI,
