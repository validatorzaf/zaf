...
public class Pravidlo61a extends K06PravidloBase {
    ...
    public Pravidlo61a() {
        super(OBS61A,
                ...
                "Příloha č. 2 NSESSS, nsesss-common.xsd, ř. 1294.");
    }
    ...
    protected void kontrola() {
        ...
        for (Element dokument : dokuments) {
            Element ad = ValuesGetter.getXChild(dokument, NsesssV4.EVIDENCNI_UDAJE, NsesssV4.MANIPULACE, NsesssV4.ANALOGOVY_DOKUMENT);
            if (ad == null) {
            ...
            Element elVlastniDokument = ValuesGetter.getXChild(dokument, NsesssV4.EVIDENCNI_UDAJE, NsesssV4.PUVOD, NsesssV4.VLASTNI_DOKUMENT);
            if ("ano".equals(hodnotaAnalogovyDokument) && elVlastniDokument != null) {
                Element elMnozstvi = ValuesGetter.getXChild(elVlastniDokument, NsesssV4.VYTVORENE_MNOZSTVI);
                if (elMnozstvi == null) {
