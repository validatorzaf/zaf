...
public class K06_Obsahova
    ...
    static public EntityId getEntityId(Element node) {
        ...
        switch (nodename) {
            case NsesssV4.VECNA_SKUPINA:
                identNode = ValuesGetter.getXChild(node, NsesssV4.EVIDENCNI_UDAJE,
                        NsesssV4.IDENTIFIKACE, NsesssV4.IDENTIFIKATOR);
            ...
            case NsesssV4.SPISOVY_PLAN:
                identNode = ValuesGetter.getXChild(node, NsesssV4.IDENTIFIKATOR);
            ...
            case NsesssV4.KOMPONENTA:
                ...
                break;
            case NsesssV4.SKARTACNI_RIZENI:
                identNode = ValuesGetter.getXChild(node, NsesssV4.IDENTIFIKATOR);
    ...
    static public Element getIdentifikator(Element element) {
        ...
        if (elementName.equals(NsesssV4.SPISOVY_PLAN)) {
            identifikator = ValuesGetter.getXChild(element, NsesssV4.IDENTIFIKATOR);
            return identifikator;
        } else {
            identifikator = ValuesGetter.getXChild(element, NsesssV4.EVIDENCNI_UDAJE,
                    NsesssV4.IDENTIFIKACE, NsesssV4.IDENTIFIKATOR);
            return identifikator;
        }
    }
    ...
    static public String getIdentifikatory(Element node) {
        ...
        Node identifikator;
        if (nodename.equals(NsesssV4.SPISOVY_PLAN)) {
            identifikator = ValuesGetter.getXChild(node, NsesssV4.IDENTIFIKATOR);
        ...
        identifikator = ValuesGetter.getXChild(node, NsesssV4.EVIDENCNI_UDAJE,
                "nsesss:Identifikace", NsesssV4.IDENTIFIKATOR);
        if (identifikator != null) {
            hodnota = identifikator.getTextContent();
            boolean ma = ValuesGetter.hasAttribut(identifikator, "zdroj");
            if (ma) {
