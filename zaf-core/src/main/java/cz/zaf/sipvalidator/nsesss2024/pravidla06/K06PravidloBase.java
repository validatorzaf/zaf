package cz.zaf.sipvalidator.nsesss2024.pravidla06;
...
public abstract class K06PravidloBase extends BaseRule<K06KontrolaContext> {
    ...
    static public boolean vratKontrolaVystupniFormat(Element zaklEntita) {
        ...
        case NsesssV4.DIL:
            datumVyrizeni = ValuesGetter.getXChild(zaklEntita, NsesssV4.EVIDENCNI_UDAJE, NsesssV4.UZAVRENI,
                                                   NsesssV4.DATUM);
            break;
        case NsesssV4.SPIS:
            datumVyrizeni = ValuesGetter.getXChild(zaklEntita, NsesssV4.EVIDENCNI_UDAJE, NsesssV4.VYRIZENI_UZAVRENI,
                                                   NsesssV4.DATUM);
            break;
        case NsesssV4.DOKUMENT:
            datumVyrizeni = ValuesGetter.getXChild(zaklEntita, NsesssV4.EVIDENCNI_UDAJE, NsesssV4.VYRIZENI,
                                                   NsesssV4.DATUM);
            break;
        default:
