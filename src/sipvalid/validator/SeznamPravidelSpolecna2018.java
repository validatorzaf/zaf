 ...
 * @author m000xz006159
 */
public class SeznamPravidelSpolecna2018 {

    static String[] seznam_pravidla = {
    "Pravidlo neexistuje.",
    //1. - 4.
    ...
    "Každá základní entita obsahuje v hierarchii dětských elementů <nsesss:EvidencniUdaje>, <nsesss:Trideni> elementy <nsesss:JednoduchySpisovyZnak> a <nsesss:PlneUrcenySpisovyZnak> se stejnými hodnotami, jaké obsahují v hierarchii dětských elementů <nsesss:EvidencniUdaje>, <nsesss:Trideni> elementy <nsesss:JednoduchySpisovyZnak> a <nsesss:PlneUrcenySpisovyZnak> rodičovské entity věcná skupina (<nsesss:VecnaSkupina>) nebo součást (<nsesss:Soucast>).",
    ...
    public static String[] seznam_popis = {
    "0 volný index",
    //1. - 4.
    ...
    "Uveden je vícekrát stejný spisový plán, věcná skupina, typový spis, součást, díl, spis, dokument, komponenta nebo bezpečnostní kategorie, skartační režim či typ dokumentu.",
    ...
    public static String[] seznam_pravidel_Datova_struktura = {
        "Index 0",
        ...
        "Chybně uvedeno označení datového balíčku SIP."
    };
